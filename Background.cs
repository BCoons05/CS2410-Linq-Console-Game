...
namespace ConsolePlatformer
{
    class Background
    {
		...
		public void DrawAmmo(Player player)
		{
			...
			Console.Write($"{(player.EquipedWeapon.BulletsInMagazine > 0 ? $"{player.EquipedWeapon.BulletsInMagazine.ToString(), +62}" : $"{"Reloading...", +62}")} / {player.EquipedWeapon.MagazineSize}");
		}
